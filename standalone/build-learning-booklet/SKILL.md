...
Create an evidence-backed learning booklet through a local, stateful, gated workflow. This directory is the complete runtime and has no repository-relative dependencies.
...
1. Resolve the installed skill directory, workspace root, and run directory. All runtime files are below the skill directory.
